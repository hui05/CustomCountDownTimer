...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mCenterText = a.getString(R.styleable.CircleProgressBar_progress_text_center);
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        if (TextUtils.isEmpty(mCenterText)) {
            ...
            mProgressTextPaint.getTextBounds(mCenterText, 0, mCenterText.length(), mProgressTextRect);
            canvas.drawText(mCenterText, mCenterX, mCenterY + mProgressTextRect.height() / 2, mProgressTextPaint);
        }
    }
